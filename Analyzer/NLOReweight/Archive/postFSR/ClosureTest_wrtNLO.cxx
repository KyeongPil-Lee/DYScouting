...
private:
  void ProducePlot_M10to50(TString histName, Bool_t doNorm = kFALSE)
  {
    ...
    canvasName.ReplaceAll("h_", "c_v2_");
    ...
    // canvas->Register( h_LOWeighted, "10 < m < 11 GeV (LO, reweighted to NLO)",  kViolet);

    if( histName == "h_diMuM" )
    {
      canvas->SetRangeX( 10, 50 );
      canvas->SetRangeY( 1, 5e4 );
...
void ClosureTest_wrtNLO()
{
  ...
  TString fileName_LOWeighted = "./Weight/LOWeighted/ROOTFile_MakeGenHist_DiMuPtRap_DYMuMu_M10to50.root";
