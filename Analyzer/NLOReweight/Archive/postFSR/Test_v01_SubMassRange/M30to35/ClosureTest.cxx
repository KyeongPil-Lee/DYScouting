...
private:
  void ProducePlot_M10to50(TString histName, Bool_t doNorm = kFALSE)
  {
    ...
    canvas->Register( h_LO,         "30 < m < 35 GeV (LO)",  kRed);
    canvas->Register( h_NLO,        "30 < m < 35 GeV (NLO)", kGreen+2);
    canvas->Register( h_LOWeighted, "30 < m < 35 GeV (LO, reweighted to NLO)",  kViolet);
