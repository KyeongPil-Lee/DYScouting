...
private:
  void ProducePlot_M10to50(TString histName, Bool_t doNorm = kFALSE)
  {
    ...
    canvas->Register( h_LO,         "11 < m < 12 GeV (LO)",  kRed);
    canvas->Register( h_NLO,        "11 < m < 12 GeV (NLO)", kGreen+2);
    canvas->Register( h_LOWeighted, "11 < m < 12 GeV (LO, reweighted to NLO)",  kViolet);
