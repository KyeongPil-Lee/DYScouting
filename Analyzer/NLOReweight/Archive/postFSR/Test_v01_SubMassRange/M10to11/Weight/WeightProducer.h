...
private:
  ...
  void Calc_Weight()
  {
    ...
    Double_t xSec_NLO = 6203.3333; // -- 18610 / 3.0: DY, 10 < M < 50 GeV
    Double_t kFactor_M40to50_NNLOtoNLO = 1.0684240278;
    Double_t xSec = xSec_NLO * kFactor_M40to50_NNLOtoNLO; // -- multpily ad-hoc k-factor: convert it to NNLO 
