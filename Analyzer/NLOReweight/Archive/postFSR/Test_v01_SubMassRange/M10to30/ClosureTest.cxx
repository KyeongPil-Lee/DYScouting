...
private:
  void ProducePlot_M10to50(TString histName, Bool_t doNorm = kFALSE)
  {
    ...
    canvas->SetTitle(titleX, titleY, "ratio to Green");

    // canvas->Register( h_DYMuMu_merged, "M10-50 + M50-inf", kBlack);
    canvas->Register( h_NLO,        "10 < m < 30 GeV (NLO)", kGreen+2);
    canvas->Register( h_LO,         "10 < m < 30 GeV (LO)",  kRed);
    canvas->Register( h_LOWeighted, "10 < m < 30 GeV (LO, reweighted to NLO)",  kViolet);
