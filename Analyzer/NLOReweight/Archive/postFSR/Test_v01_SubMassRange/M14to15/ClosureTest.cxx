...
private:
  void ProducePlot_M10to50(TString histName, Bool_t doNorm = kFALSE)
  {
    ...
    canvas->Register( h_LO,         "14 < m < 15 GeV (LO)",  kRed);
    canvas->Register( h_NLO,        "14 < m < 15 GeV (NLO)", kGreen+2);
    canvas->Register( h_LOWeighted, "14 < m < 15 GeV (LO, reweighted to NLO)",  kViolet);
