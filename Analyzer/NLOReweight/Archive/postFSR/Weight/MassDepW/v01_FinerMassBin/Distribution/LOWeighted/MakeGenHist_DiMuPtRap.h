...
#include <NLOReweight/postFSR/Weight/MassDepW/v01_FinerMassBin/Distribution/HistContainer.h>
#include <NLOReweight/postFSR/Weight/MassDepW/v01_FinerMassBin/NLOWeightTool.h>
...
public:
  ...
  void Run()
  {
    ...
    HistContainer* hists_inc = new HistContainer(); // -- inclusive in dimuon mass
    ...
    for(Int_t i=0; i<nEvent; i++)
    {
      ...
      if( DYTool::SelectGenEventBySampleType(sampleInfo_.type, ntuple) )
      {
        ...
        if( nGenLeptonHP == 2 )
        {
          ...
          hists_inc->FillHistogram( vec_genLepton[0], vec_genLepton[1], totWeight );
        }
      }
    }
    ...
    f_output->cd();
    hists_inc->SaveHistogram(f_output);
