...
private:
  void DrawPlot(TString var)
  {
    ...
    if( var == "diMuPt" )  canvas->SetRangeX(0, 1000);
    if( var == "diMuRap" ) canvas->SetRangeX(-10, 10);

    // if( var == "diMuRap" ) canvas->SetRangeY(1e-8, 1.0);
    if( var == "diMuPt" ) canvas->SetRangeY(1e-4, 2.0);

    if( var == "diMuM" )  canvas->SetRangeRatio(0.8, 1.2);
    if( var == "diMuRap" ) canvas->SetRangeRatio(0.8, 1.2);
