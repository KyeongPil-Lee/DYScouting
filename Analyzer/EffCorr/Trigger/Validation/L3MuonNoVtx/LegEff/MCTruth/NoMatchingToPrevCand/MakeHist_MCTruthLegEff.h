...
private:
  ...
  Bool_t IsMatched_L3MuonNoVtx_CustomSingleMu3Filter(DYTool::OffMuon mu, DYTool::DYTree *ntuple)
  {
    vector<DYTool::L3MuonNoVtx> vec_filterObj;
    // Bool_t flag_pass = DYTool::CustomSingleMuFilter_MimicDoubleMu3Leg(ntuple, vec_filterObj);
    Bool_t flag_pass = CustomSingleMuFilter_MimicDoubleMu3Leg_noMatchingToPrevCand(ntuple, vec_filterObj);
  ...
  Bool_t CustomSingleMuFilter_MimicDoubleMu3Leg_noMatchingToPrevCand(DYTool::DYTree *ntuple, vector<DYTool::L3MuonNoVtx> &vec_filterObj)
  {
    vec_filterObj.clear();
    ...
    for( auto& L3MuonNoVtx : vec_L3MuonNoVtx )
    {
      ...
      Double_t dR_L2 = 0.5;
      // Bool_t isMatched_L1 = dRMatching_HLTObj(L3MuonNoVtx.vecP, ntuple, "hltDimuon3L1Filtered0",    dR_L1);
      // Bool_t isMatched_L2 = dRMatching_HLTObj(L3MuonNoVtx.vecP, ntuple, "hltDimuon3L2PreFiltered0", dR_L2);

      // Bool_t isMatched_prevCand = isMatched_L1 || isMatched_L2;
      Bool_t isMatched_prevCand = kTRUE;
