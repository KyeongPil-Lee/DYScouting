...
generator.ROOTCodePath = GetCWD()+"/MakeHist_Statistics_Probe.h"
generator.className = "HistProducer"

generator.luminosity = 59740.565202 # -- 2018
generator.jsonName = "SampleInfo_v1p8.json" # -- under DY_ANALYZER_PATH/Include

# -- if "_skim" is added, it runs over skimmed ntuples
generator.dic_nJob = { 
  # "DYMuMu_M10to50":    10,
  "JPsiToMuMu_JPsiPt8_Pythia8":   30,
  }
