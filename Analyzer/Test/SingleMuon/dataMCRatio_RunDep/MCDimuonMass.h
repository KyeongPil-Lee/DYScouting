...
public:
  ...
  void Run()
  {
    ...
    // -- histogram
    OfflineZPeakHistContainer* hist_IsoMu24Z = new OfflineZPeakHistContainer("");
    OfflineZPeakHistContainer* hist_L1       = new OfflineZPeakHistContainer("");
    OfflineZPeakHistContainer* hist_HLT      = new OfflineZPeakHistContainer("");
    ...
    TString outputName = GetOutputFileName("MCDimuonMass");
