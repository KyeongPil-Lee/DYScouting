  ...
  void Run()
  {
    ...
    for(Int_t i=0; i<nEvent; i++)
    {
      ...
      if( DYTool::SelectGenEventBySampleType(sampleInfo_.type, ntuple) )
      {
        ...
        Bool_t isDYEvent_L1IsoMu24Z = kFALSE;
        DYTool::OffMuPair DYMuPair = OfflineEventSelection_L1IsoMu24_ZMassWindow(ntuple, isDYEvent_L1IsoMu24Z);

        if( isDYEvent_L1IsoMu24Z )
        {
          // -- test: does it fail to pass the selection with HLT on top of the previous selection?
          Bool_t isDYEvent_L1HLTIsoMu24 = kFALSE;
          DYTool::OffMuPair DYMuPair_L1HLTIsoMu24 = OfflineEventSelection_L1HLTIsoMu24(ntuple, isDYEvent_L1HLTIsoMu24);

          if( !isDYEvent_L1HLTIsoMu24 )
          {
        ...
        } // -- end of if( isDYEvent_L1IsoMu24Z )
...
private:
  DYTool::OffMuPair OfflineEventSelection_L1IsoMu24_ZMassWindow(DYTool::DYTree* ntuple, Bool_t& doPass)
  {
    DYTool::OffMuPair muPair_dummy;

    DYTool::OffMuPair DYMuPair = OfflineEventSelection_L1IsoMu24(ntuple, doPass);
  ...
  DYTool::OffMuPair OfflineEventSelection_L1IsoMu24(DYTool::DYTree* ntuple, Bool_t& doPass)
  {
    doPass = kFALSE;
  ...
  DYTool::OffMuPair OfflineEventSelection_L1HLTIsoMu24(DYTool::DYTree* ntuple, Bool_t& doPass)
  {
    doPass = kFALSE;
