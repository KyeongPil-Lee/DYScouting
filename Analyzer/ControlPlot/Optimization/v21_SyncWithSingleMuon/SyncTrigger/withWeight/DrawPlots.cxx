...
private:
  void Init()
  {
    ...
    TString basePath = "./";
    TString baseFileName = "ROOTFile_MakeHist_Dimuon";
    ...
    TString tag_data  = "ScoutingCaloMuon_Run2018All";
    TString tag_ttbar = "ttbar";
    TString tag_WJets = "WJets";

    vector<TString> vec_tag_DYMuMu   = { "DYMuMu_M10to50", "DYMuMu_M50toInf" };
    vector<TString> vec_tag_DYTauTau = { "DYTauTau_M10to50", "DYTauTau_M50toInf" };
  ...
  void Produce_StackedPlot()
  {
    ...
    if( histName_.Contains("h_diMuM") ) canvas->SetRangeRatio(0.8, 1.2);
