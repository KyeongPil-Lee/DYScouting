...
generator.jobName = "MakeGenHist" # -- used for workspace name
generator.ROOTCodePath = GetCWD()+"/MakeGenHist_Dimuon.h"
generator.className = "HistProducer"

generator.luminosity = 59740.565202 # -- 2018 lumi. in /pb
