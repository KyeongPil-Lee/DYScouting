...
int TMVAClassification( TString myMethodList = "" )
{
  ...
  TFile *f_input_signal = TFile::Open(analyzerPath+"/BDT/TreeMaker/ROOTFile_BDTInputTree_DYJetsToLL_M10to50_Madgraph.root");
  TFile *f_input_bkg    = TFile::Open(analyzerPath+"/BDT/TreeMaker/ROOTFile_BDTInputTreeProducer_QCDMuEnriched_Pt15to470.root");
