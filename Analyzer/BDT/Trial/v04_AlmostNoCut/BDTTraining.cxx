...
int TMVAClassification( TString myMethodList = "" )
{
  ...
  TFile *f_input_signal = TFile::Open(analyzerPath+"/BDT/Trial/v04_AlmostNoCut/TreeMaker/ROOTFile_BDTInputTreeProducer_DYMuMu_M10to50.root");
  TFile *f_input_bkg    = TFile::Open(analyzerPath+"/BDT/Trial/v04_AlmostNoCut/TreeMaker/ROOTFile_BDTInputTreeProducer_QCDMuEnriched_Pt15to300.root");
  ...
  dataloader->AddVariable( "diMuSignSum",   "Charge sum of two muons", "", 'I' );
  ...
  dataloader->PrepareTrainingAndTestTree( mycuts, "nTrain_Signal=250000:nTrain_Background=250000:nTest_Signal=250000:nTest_Background=250000:SplitMode=Random:!V" );
