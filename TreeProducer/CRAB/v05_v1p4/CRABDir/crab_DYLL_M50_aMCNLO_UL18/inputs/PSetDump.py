...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/k/kplee/private/ROOTFile_Test/106X/UL18/MINIAODSIM_DYLL_M50_aMCNLO_Summer19UL18.root'),
...
process.DYTree = cms.EDAnalyzer("DYTreeProducer",
    L1SeedList = cms.untracked.vstring(
        'L1_DoubleMu_12_5', 
        'L1_DoubleMu_12_8', 
        'L1_DoubleMu_13_6', 
        'L1_DoubleMu_15_5', 
    ...
    PUSummaryInfo = cms.untracked.InputTag("slimmedAddPileupInfo"),
    ...
    offlineVertex = cms.untracked.InputTag("offlineSlimmedPrimaryVertices"),
